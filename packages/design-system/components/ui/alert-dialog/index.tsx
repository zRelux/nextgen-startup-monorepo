...
type IAlertDialogProps = React.ComponentProps<typeof UIAccessibleAlertDialog> & VariantProps<typeof alertDialogStyle>;

type IAlertDialogContentProps = React.ComponentProps<typeof UIAccessibleAlertDialog.Content> &
	VariantProps<typeof alertDialogContentStyle>;

type IAlertDialogCloseButtonProps = React.ComponentProps<typeof UIAccessibleAlertDialog.CloseButton> &
	VariantProps<typeof alertDialogCloseButtonStyle>;

type IAlertDialogHeaderProps = React.ComponentProps<typeof UIAccessibleAlertDialog.Header> &
	VariantProps<typeof alertDialogHeaderStyle>;

type IAlertDialogFooterProps = React.ComponentProps<typeof UIAccessibleAlertDialog.Footer> &
	VariantProps<typeof alertDialogFooterStyle>;

type IAlertDialogBodyProps = React.ComponentProps<typeof UIAccessibleAlertDialog.Body> &
	VariantProps<typeof alertDialogBodyStyle>;

type IAlertDialogBackdropProps = React.ComponentProps<typeof UIAccessibleAlertDialog.Backdrop> &
	VariantProps<typeof alertDialogBackdropStyle>;

const AlertDialog = React.forwardRef(
	({ className, size = "md", ...props }: { className?: string } & IAlertDialogProps, ref?: any) => {
		return (
...
const AlertDialogContent = React.forwardRef(
	({ className, size, ...props }: { className?: string } & IAlertDialogContentProps, ref?: any) => {
...
const AlertDialogCloseButton = React.forwardRef(
	({ className, ...props }: { className?: string } & IAlertDialogCloseButtonProps, ref?: any) => {
		return (
...
const AlertDialogHeader = React.forwardRef(
	({ className, ...props }: { className?: string } & IAlertDialogHeaderProps, ref?: any) => {
		return (
...
const AlertDialogFooter = React.forwardRef(
	({ className, ...props }: { className?: string } & IAlertDialogFooterProps, ref?: any) => {
		return (
...
const AlertDialogBody = React.forwardRef(
	({ className, ...props }: { className?: string } & IAlertDialogBodyProps, ref?: any) => {
		return (
...
const AlertDialogBackdrop = React.forwardRef(
	({ className, ...props }: { className?: string } & IAlertDialogBackdropProps, ref?: any) => {
		return (
