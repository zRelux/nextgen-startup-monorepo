...
const UIButton = createButton({
	...
	Icon: Platform.OS === "web" ? withStates(PrimitiveIcon) : withStates(PrimitiveIcon),
});
...
type IButtonProps = Omit<React.ComponentProps<typeof UIButton>, "context"> & VariantProps<typeof buttonStyle>;
const Button = React.forwardRef(
	(
		{ className, variant = "solid", size = "md", action = "primary", ...props }: { className?: string } & IButtonProps,
		ref?: any,
	) => {
		return (
			<UIButton
...
type IButtonTextProps = React.ComponentProps<typeof UIButton.Text> & VariantProps<typeof buttonTextStyle>;
const ButtonText = React.forwardRef(
	({ className, variant, size, action, ...props }: { className?: string } & IButtonTextProps, ref?: any) => {
...
type IButtonIcon = React.ComponentProps<typeof UIButton.Icon> & VariantProps<typeof buttonIconStyle>;
...
type IButtonGroupProps = React.ComponentProps<typeof UIButton.Group> & VariantProps<typeof buttonGroupStyle>;
const ButtonGroup = React.forwardRef(
	(
		{ className, space = "md", isAttached = false, ...props }: { className?: string } & IButtonGroupProps,
		ref?: any,
	) => {
		return (
