...
type IModalProps = React.ComponentProps<typeof UIModal> & VariantProps<typeof modalStyle>;

type IModalBackdropProps = React.ComponentProps<typeof UIModal.Backdrop> & VariantProps<typeof modalBackdropStyle>;

type IModalContentProps = React.ComponentProps<typeof UIModal.Content> & VariantProps<typeof modalContentStyle>;

type IModalHeaderProps = React.ComponentProps<typeof UIModal.Header> & VariantProps<typeof modalHeaderStyle>;

type IModalBodyProps = React.ComponentProps<typeof UIModal.Body> & VariantProps<typeof modalBodyStyle>;

type IModalFooterProps = React.ComponentProps<typeof UIModal.Footer> & VariantProps<typeof modalFooterStyle>;
...
const ModalBackdrop = React.forwardRef(
	({ className, ...props }: { className?: string } & IModalBackdropProps, ref?: any) => {
		return (
			<UIModal.Backdrop
				ref={ref}
				initial={{
...
const ModalContent = React.forwardRef(
	({ className, size, ...props }: { className?: string } & IModalContentProps, ref?: any) => {
...
const ModalHeader = React.forwardRef(
	({ className, ...props }: { className?: string } & IModalHeaderProps, ref?: any) => (
		<UIModal.Header
			ref={ref}
			{...props}
...
const ModalBody = React.forwardRef(({ className, ...props }: { className?: string } & IModalBodyProps, ref?: any) => (
	<UIModal.Body
		ref={ref}
		{...props}
...
const ModalFooter = React.forwardRef(
	({ className, ...props }: { className?: string } & IModalFooterProps, ref?: any) => (
		<UIModal.Footer
			ref={ref}
			{...props}
...
const ModalCloseButton = React.forwardRef(
	({ className, ...props }: { className?: string } & IModalCloseButtonProps, ref?: any) => (
		<UIModal.CloseButton
			ref={ref}
			{...props}
