...
const ActionsheetItem = React.forwardRef(({ className, ...props }: IActionsheetItemProps, ref?: any) => {
	return (
		<UIActionsheet.Item
...
const ActionsheetItemText = React.forwardRef(
	(
		{ isTruncated, bold, underline, strikeThrough, size = "sm", className, ...props }: IActionsheetItemTextProps,
		ref?: any,
	) => {
		return (
...
const ActionsheetScrollView = React.forwardRef(({ className, ...props }: IActionsheetScrollViewProps, ref?: any) => {
	return (
...
const ActionsheetFlatList = React.forwardRef(({ className, ...props }: IActionsheetFlatListProps, ref?: any) => {
	return (
...
const ActionsheetSectionList = React.forwardRef(({ className, ...props }: IActionsheetSectionListProps, ref?: any) => {
	return (
