...
const FormControl = ({ className, size = "md", ...props }: { className?: string } & IFormControlProps) => {
...
const FormControlError = ({ className, ...props }: { className?: string } & IFormControlErrorProps) => {
...
const FormControlLabel = ({ className, ...props }: { className?: string } & IFormControlLabelProps) => {
...
const FormControlLabelText = ({ className, size, ...props }: { className?: string } & IFormControlLabelTextProps) => {
	const { size: parentSize } = useStyleContext(SCOPE);
...
const FormControlHelper = ({ className, ...props }: { className?: string } & IFormControlHelperProps) => {
	return (
...
const FormControlHelperText = ({ className, size, ...props }: { className?: string } & IFormControlHelperTextProps) => {
	const { size: parentSize } = useStyleContext(SCOPE);
