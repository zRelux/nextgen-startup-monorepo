...
type IHeadingProps = VariantProps<typeof headingStyle> & React.ComponentProps<typeof H1>;
...
const MappedHeading = memo(
	forwardRef(
		(
			{ size, className, isTruncated, bold, underline, strikeThrough, sub, italic, highlight, ...props }: IHeadingProps,
			ref?: any,
		) => {
			switch (size) {
				case "5xl":
