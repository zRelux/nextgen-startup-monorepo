...
type IAvatarProps = Omit<React.ComponentProps<typeof UIAvatar>, "context"> & VariantProps<typeof avatarStyle>;
export const Avatar = React.forwardRef(
	({ className, size = "md", ...props }: { className?: string } & IAvatarProps, ref?: any) => {
		return <UIAvatar ref={ref} {...props} className={avatarStyle({ size, class: className })} context={{ size }} />;
	},
);

type IAvatarBadgeProps = React.ComponentProps<typeof UIAvatar.Badge> & VariantProps<typeof avatarBadgeStyle>;
export const AvatarBadge = React.forwardRef(
	({ className, size, ...props }: { className?: string } & IAvatarBadgeProps, ref?: any) => {
...
type IAvatarFallbackTextProps = React.ComponentProps<typeof UIAvatar.FallbackText> &
	VariantProps<typeof avatarFallbackTextStyle>;
export const AvatarFallbackText = React.forwardRef(
	({ className, size, ...props }: { className?: string } & IAvatarFallbackTextProps, ref?: any) => {
		const { size: parentSize } = useStyleContext(SCOPE);
...
type IAvatarImageProps = React.ComponentProps<typeof UIAvatar.Image> & VariantProps<typeof avatarImageStyle>;
export const AvatarImage = React.forwardRef(
	({ className, ...props }: { className?: string } & IAvatarImageProps, ref?: any) => {
		return (
			<UIAvatar.Image
				ref={ref}
				{...props}
...
type IAvatarGroupProps = React.ComponentProps<typeof UIAvatar.Group> & VariantProps<typeof avatarGroupStyle>;
export const AvatarGroup = React.forwardRef(
	({ className, ...props }: { className?: string } & IAvatarGroupProps, ref?: any) => {
		return (
			<UIAvatar.Group
				ref={ref}
				{...props}
