...
const BadgeText = ({ children, className, size, ...props }: { className?: string } & IBadgeTextProps) => {
...
type IBadgeIconProps = React.ComponentProps<typeof PrimitiveIcon> & VariantProps<typeof badgeIconStyle>;
