...
export const Slider = React.forwardRef(
	({ className, size = "md", orientation = "horizontal", isReversed = false, ...props }: any, ref?: any) => {
		return (
			<UISlider
				ref={ref}
...
export const SliderThumb = React.forwardRef(({ className, size, ...props }: any, ref?: any) => {
...
export const SliderTrack = React.forwardRef(({ className, ...props }: any, ref?: any) => {
...
export const SliderFilledTrack = React.forwardRef(({ className, ...props }: any, ref?: any) => {
