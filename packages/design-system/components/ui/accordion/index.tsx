...
const PrimitiveIcon = React.forwardRef(
	({ height, width, fill, color, size, stroke = "currentColor", as: AsComp, ...props }: any, ref?: any) => {
...
type IAccordionProps = React.ComponentProps<typeof UIAccordion> & VariantProps<typeof accordionStyle>;

type IAccordionItemProps = React.ComponentProps<typeof UIAccordion.Item> & VariantProps<typeof accordionItemStyle>;

type IAccordionContentProps = React.ComponentProps<typeof UIAccordion.Content> &
	VariantProps<typeof accordionContentStyle>;

type IAccordionContentTextProps = React.ComponentProps<typeof UIAccordion.ContentText> &
...
type IAccordionTitleTextProps = React.ComponentProps<typeof UIAccordion.TitleText> &
	VariantProps<typeof accordionTitleTextStyle>;

/** Components */

const Accordion = React.forwardRef(
	({ className, variant = "filled", size = "md", ...props }: { className?: string } & IAccordionProps, ref?: any) => {
		return (
			<UIAccordion
				ref={ref}
				{...props}
...
const AccordionItem = React.forwardRef(
	({ className, ...props }: { className?: string } & IAccordionItemProps, ref?: any) => {
...
const AccordionContent = React.forwardRef(
	({ className, ...props }: { className?: string } & IAccordionContentProps, ref?: any) => {
		return (
			<UIAccordion.Content
				ref={ref}
				{...props}
...
const AccordionContentText = React.forwardRef(
	({ className, ...props }: { className?: string } & IAccordionContentTextProps, ref?: any) => {
...
const AccordionHeader = React.forwardRef(
	({ className, ...props }: { className?: string } & IAccordionHeaderProps, ref?: any) => {
		return (
			<UIAccordion.Header
				ref={ref}
				{...props}
...
const AccordionTrigger = React.forwardRef(
	({ className, ...props }: { className?: string } & IAccordionTriggerProps, ref?: any) => {
		return (
			<UIAccordion.Trigger
				ref={ref}
				{...props}
...
const AccordionTitleText = React.forwardRef(
	({ className, ...props }: { className?: string } & IAccordionTitleTextProps, ref?: any) => {
		const { size } = useStyleContext(SCOPE);
		return (
