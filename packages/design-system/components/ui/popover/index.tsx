...
const Popover = React.forwardRef(
	({ className, size = "md", placement = "bottom", ...props }: { className?: string } & IPopoverProps, ref?: any) => {
		return (
			<UIPopover
				ref={ref}
				placement={placement}
...
const PopoverContent = React.forwardRef(
	({ className, size, ...props }: { className?: string } & IPopoverContentProps, ref?: any) => {
...
const PopoverArrow = React.forwardRef(
	({ className, ...props }: { className?: string } & IPopoverArrowProps, ref?: any) => {
...
const PopoverBackdrop = React.forwardRef(
	({ className, ...props }: { className?: string } & IPopoverBackdropProps, ref?: any) => {
		return (
			<UIPopover.Backdrop
				ref={ref}
				{...props}
...
const PopoverBody = React.forwardRef(
	({ className, ...props }: { className?: string } & IPopoverBodyProps, ref?: any) => (
		<UIPopover.Body
			ref={ref}
			{...props}
...
const PopoverCloseButton = React.forwardRef(
	({ className, ...props }: { className?: string } & IPopoverCloseButtonProps, ref?: any) => (
...
const PopoverFooter = React.forwardRef(
	({ className, ...props }: { className?: string } & IPopoverFooterProps, ref?: any) => (
		<UIPopover.Footer
			ref={ref}
			{...props}
...
const PopoverHeader = React.forwardRef(
	({ className, ...props }: { className?: string } & IPopoverHeaderProps, ref?: any) => (
		<UIPopover.Header
			ref={ref}
			{...props}
