...
export const Progress = React.forwardRef(({ className, size = "md", ...props }: IProgressProps, ref?: any) => {
	return <UIProgress ref={ref} {...props} className={progressStyle({ size, class: className })} context={{ size }} />;
});

export const ProgressFilledTrack = React.forwardRef(({ className, ...props }: IProgressFilledTrackProps, ref?: any) => {
