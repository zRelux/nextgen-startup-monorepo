...
const SelectTriggerWrapper = React.forwardRef(({ ...props }: any, ref?: any) => {
...
const Select = React.forwardRef(({ className, ...props }: ISelectProps & { className?: string }, ref?: any) => {
	return (
		<UISelect
...
const SelectTrigger = React.forwardRef(
	(
		{ className, size = "md", variant = "outline", ...props }: ISelectTriggerProps & { className?: string },
		ref?: any,
	) => {
		return (
			<UISelect.Trigger
...
const SelectInput = React.forwardRef(
	({ className, ...props }: ISelectInputProps & { className?: string }, ref?: any) => {
...
type ISelectIcon = VariantProps<typeof selectIconStyle> & React.ComponentProps<typeof UISelect.Icon>;
