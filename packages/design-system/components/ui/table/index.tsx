...
const Table = React.forwardRef(({ className, ...props }: ITableProps, ref?: any) => {
	return <ExpoTable ref={ref} className={tableStyle({ class: className })} {...props} />;
});

const TableHeader = React.forwardRef(({ className, ...props }: ITableHeaderProps, ref?: any) => {
...
const TableBody = React.forwardRef(({ className, ...props }: ITableBodyProps, ref?: any) => {
	return <ExpoTBody ref={ref} className={tableBodyStyle({ class: className })} {...props} />;
});

const TableFooter = React.forwardRef(({ className, ...props }: ITableFooterProps, ref?: any) => {
	const contextValue = useMemo(() => {
		return {
			isFooterRow: true,
		};
...
const TableHead = React.forwardRef(({ useRNView = false, className, ...props }: ITableHeadProps, ref?: any) => {
	if (useRNView) {
...
const TableRow = React.forwardRef(({ className, ...props }: ITableRowProps, ref?: any) => {
...
const TableData = React.forwardRef(({ useRNView = false, className, ...props }: ITableDataProps, ref?: any) => {
	if (useRNView) {
...
const TableCaption = React.forwardRef(({ className, ...props }: ITableCaptionProps, ref?: any) => {
