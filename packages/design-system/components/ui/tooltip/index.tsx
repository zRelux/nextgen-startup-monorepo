...
type ITooltipContentProps = React.ComponentProps<typeof UITooltip.Content> & VariantProps<typeof tooltipContentStyle>;
type ITooltipTextProps = React.ComponentProps<typeof UITooltip.Text> & VariantProps<typeof tooltipTextStyle>;

export const Tooltip = React.forwardRef(
	({ className, ...props }: { className?: string } & ITooltipProps, ref?: any) => {
		return <UITooltip ref={ref} className={tooltipStyle({ class: className })} {...props} />;
	},
);

export const TooltipContent = React.forwardRef(
	({ className, ...props }: { className?: string } & ITooltipContentProps, ref?: any) => {
		return (
			<UITooltip.Content
				ref={ref}
				{...props}
...
export const TooltipText = React.forwardRef(
	({ className, size = "md", ...props }: { className?: string } & ITooltipTextProps, ref?: any) => {
