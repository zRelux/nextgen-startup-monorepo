...
type IFabProps = Omit<React.ComponentProps<typeof UIFab>, "context"> & VariantProps<typeof fabStyle>;
const Fab = React.forwardRef(
	({ size = "md", placement = "bottom right", className, ...props }: { className?: string } & IFabProps, ref?: any) => {
		return (
...
type IFabLabelProps = React.ComponentProps<typeof UIFab.Label> & VariantProps<typeof fabLabelStyle>;
...
type IFabIconProps = React.ComponentProps<typeof UIFab.Icon> & VariantProps<typeof fabIconStyle>;
