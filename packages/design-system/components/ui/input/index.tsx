...
type IInputProps = React.ComponentProps<typeof UIInput> & VariantProps<typeof inputStyle>;
const Input = React.forwardRef(
	({ className, variant = "outline", size = "md", ...props }: { className?: string } & IInputProps, ref?: any) => {
		return (
			<UIInput
				ref={ref}
				{...props}
...
type IInputSlotProps = React.ComponentProps<typeof UIInput.Slot> & VariantProps<typeof inputSlotStyle>;
const InputSlot = React.forwardRef(({ className, ...props }: { className?: string } & IInputSlotProps, ref?: any) => {
	return (
		<UIInput.Slot
			ref={ref}
			{...props}
...
type IInputFieldProps = React.ComponentProps<typeof UIInput.Input> & VariantProps<typeof inputFieldStyle>;
const InputField = React.forwardRef(({ className, ...props }: { className?: string } & IInputFieldProps, ref?: any) => {
